...
contract RedeemViaSeaport1155 is BaseOrderTest, RedeemablesErrorsAndEvents {
    using OrderParametersLib for OrderParameters;

    error InvalidContractOrder(bytes32 orderHash);

    RedeemableContractOfferer offerer;
    TestERC1155 redeemableToken;
    ERC1155RedemptionMintable redemptionToken;
    ...
    function setUp() public override {
        ...
        redeemableToken = new TestERC1155();
        redemptionToken = new ERC1155RedemptionMintable(
            address(offerer),
    ...
    function testRedeemWithSeaport() public {
        ...
        redeemableToken.mint(address(this), tokenId, amount);
    ...
    function testRedeemAndSendErc20ToThirdAddressViaSeaport() public {
...

        {
            ...
            campaignConsideration[0].itemType = ItemType.ERC1155;
    ...
    function xtestRedeemWithCriteriaResolversViaSeaport() public {
        uint256 tokenId = 2;
        uint256 amount = 10 ** 18;
        redeemableToken.mint(address(this), tokenId, amount);
        redeemableToken.setApprovalForAll(address(conduit), true);
    ...
    //         assertEq(
    //             redemptionTokenTwo.ownerOf(redemptionTokenId),
    //             address(this)
    //         );
    //     }
    // }
