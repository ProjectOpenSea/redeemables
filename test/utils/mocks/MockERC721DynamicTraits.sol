...
contract MockERC721DynamicTraits is ERC721, IERC7XXX {
    ...
    // The dynamic traits
    mapping(bytes32 traitKey => mapping(uint256 tokenId => bytes32 value))
        public traits;
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(ERC721, IERC7XXX) returns (bool) {
        return
            interfaceId == type(IERC7XXX).interfaceId ||
