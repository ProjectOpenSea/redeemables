...
import { IERCDynamicTraitsRegistry } from
    "../../src/interfaces/IDynamicTraitsRegistry.sol";
...
contract BaseTest is Test, IERCDynamicTraits, IERCDynamicTraitsRegistry {
    ...
    bytes32 internal constant _EIP_712_DOMAIN_TYPEHASH = keccak256(
    ...
    function _domainSeparator(address contractAddr)
        internal
        view
        returns (bytes32)
    {
    ...
    function getTrait(uint256, bytes32)
        public
        view
        virtual
        override
    ...
    function getTrait(address, uint256, bytes32)
        external
        pure
        returns (bytes32)
    {
    ...
    function setTraitBulk(address, uint256, uint256, bytes32, bytes32)
        external
    { }
